...
*Owner: Product Manager (Agent 1) · Last updated: 2026-06-01 (SIM-432 CLOSED — calibration is now LIVE: fit + validate scripts reconciled to the live schema, `/data/calibration.json` fitted + applied at boot, win-prob map is a fitted reliability-curve [was identity]. Remaining open: perf SIM-430 [fan-out/OOM half]; P2 sim-realism SIM-411 + SIM-413 [play-pool-rebuild-blocked]; SIM-429 granular run/prop calibration + CLV backtest. SIM-402/406/407/408/431/432 all closed.)*
